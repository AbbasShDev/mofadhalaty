...
$stat = $mysqli->query("SELECT urls.*, sections.section_name  FROM urls LEFT OUTER JOIN sections ON sections.section_id=urls.section_id WHERE urls.user_id=$userId AND urls.url_favourite=1 AND urls.url_archive=0 ORDER BY urls.url_id DESC");
...
<div class="content">
    <div class="container col-11">
        <h5 class="list-title mt-5 mb-4 text-center text-lg-left">المفضلة<span></span></h5>
